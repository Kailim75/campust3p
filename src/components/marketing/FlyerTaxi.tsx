    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="min-h-screen bg-gradient-to-b from-[#F5EBD7] to-white print:break-after-page">
        ...
        <div className="bg-gradient-to-r from-emerald-600 to-emerald-800 text-white py-8 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex items-center justify-center gap-3 mb-4">
              <Car className="h-12 w-12 text-yellow-300" />
        ...
        <div className="py-8 px-4 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-block bg-gradient-to-r from-emerald-600 to-emerald-700 text-white rounded-2xl px-10 py-6 shadow-xl">
              <div className="text-5xl md:text-7xl font-extrabold">239€</div>
              <div className="text-xl text-emerald-100">TTC - Tout compris</div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                { icon: Shield, text: "Agréé préfecture", subtext: `N° ${ORGANISME.agreementVTCTAXI}` },
              ].map((item, index) => (
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-3">
              {[
                ...
                "Formateurs experts du secteur taxi",
        ...
        {/* CTA Section */}
        <div className="py-10 px-4 bg-gradient-to-r from-emerald-600 to-emerald-800">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <a
              href="tel:0783787663"
              className="inline-flex items-center gap-3 bg-yellow-400 hover:bg-yellow-500 text-[#1B4D3E] font-bold text-2xl px-10 py-5 rounded-xl shadow-lg transition-all"
            >
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-[#F5EBD7] print:break-before-page">
        ...
        <div className="bg-emerald-600 text-white py-6 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold">
              Programme de Formation TAXI - 14 heures
            </h2>
          </div>
        </div>
        ...
        {/* Objectifs */}
        <div className="py-8 px-4 bg-emerald-50">
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="bg-gradient-to-r from-emerald-50 to-emerald-100 border-emerald-200">
              <CardContent className="p-6">
                ...
                <blockquote className="text-center text-gray-700 italic mb-3">
                  "Excellente formation ! Les formateurs connaissent parfaitement le métier de taxi. Je recommande !"
                </blockquote>
                <p className="text-center text-gray-500 font-medium">
                  — Ahmed B., Artisan taxi depuis 2015
                </p>
              </CardContent>
            </Card>
          </div>
