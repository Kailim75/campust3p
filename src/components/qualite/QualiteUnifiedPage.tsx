...
const TABS = ['qualiopi', 'criteres', 'actions', 'audits', 'simulation', 'satisfaction'] as const;
  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        ...
        subtitle={`${centreData?.scoreConformite || conformiteRate}% de conformité • ${actionsEnCours} actions en cours`}
      />
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="card-elevated p-4 border-primary/20">
          ...
          <p className="text-2xl font-bold">{centreData?.scoreConformite || 0}%</p>
          <p className="text-xs text-muted-foreground mt-1">
            {centreData?.isQualiopiReady ? '✅ Qualiopi Ready' : '⚠️ À améliorer'}
          </p>
        </div>
        ...
        <div className="card-elevated p-4 border-green-500/20">
        ...
        <div className="card-elevated p-4">
          ...
          <p className="text-2xl font-bold">{centreData?.avgSatisfaction || 0}/5</p>
          <p className="text-xs text-muted-foreground mt-1">
            {centreData?.totalSatisfactionReponses || 0} réponses
          </p>
        </div>
      </div>
