...
| 10/09/2026 | **Lot 4/4 — authentification des emails automatiques** : `send-automated-emails` (doublon de rappel retiré, `?dryRun=true`, déduplication, chemins cron/JWT exclusifs) | `correctifs-lot2` | 🟡 à merger — **redéploiement suspendu à l’accord explicite de Karim** |
