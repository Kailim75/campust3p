...
BEGIN
  ...
  INSERT INTO public.audit_logs (centre_id, table_name, record_id, action, new_data, user_id, user_email)
  VALUES (v_centre_id, 'catalogue_formations', p_catalogue_id, 'catalogue_track_recalc',
